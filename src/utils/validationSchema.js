...
export const signUpSchema = Yup.object().shape({
  ...
  phoneNumber: Yup.string()
    .matches(phoneRegExp, ' Pakistani mobile number (03XX-XXXXXXX)')
...
export const additionalDetailsSchema = Yup.object().shape({
  phoneNumber: Yup.string()
    .matches(phoneRegExp, 'your phone number not found in record (03XXXXXXXXX)')
    .required('mobile number is require'),
  cnic: Yup.string()
    .matches(cnicRegExp, 'CNIC must be write in XXXXX-XXXXXXX-X')
    .required('CNIC is require'),
}); 