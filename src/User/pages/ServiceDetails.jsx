              ...
              >
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-600">+92 00000000000</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <FaEnvelope className="h-5 w-5 text-blue-600" />
                    <span className="text-gray-600">abc@.com</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <FaMapMarkerAlt className="h-5 w-5 text-blue-600" />
                    <span className="text-gray-600">Saylani, Pakistan</span>
                  </div>
                </div>
              </motion.div>
            </div>
